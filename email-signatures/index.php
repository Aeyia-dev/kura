...
function generateSignature($name, $email, $phone) {
    ...
    return '
<div style="font-family: Arial, Helvetica, sans-serif; color: #212025; max-width: 500px;">
    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
        <tr>
            <!-- Name and Social Icons Column -->
            <td style="vertical-align: top;">
                <div style="font-size: 17pt; color: #212025; font-weight: normal; padding-bottom: 5px;">' . htmlspecialchars($name) . '</div>
                <div style="padding-top: 5px;">
                    <a href="https://www.instagram.com/aeyia_/" style="text-decoration: none !important; display: inline-block; margin-right: 5px;">
                        <img src="' . $s3BaseUrl . '/instagram.png" alt="Instagram" style="width: 21px; height: 21px; border: 0;">
                    </a>
                    <a href="http://www.facebook.com/aeyia.au" style="text-decoration: none !important; display: inline-block; margin-right: 5px;">
                        <img src="' . $s3BaseUrl . '/facebook.png" alt="Facebook" style="width: 21px; height: 21px; border: 0;">
                    </a>
                    <a href="http://www.tiktok.com/@aeyia__" style="text-decoration: none !important; display: inline-block; margin-right: 5px;">
            ...
            <td style="padding: 0 15px; vertical-align: top;">
                <div style="width: 1px; background-color: #666666; height: 100%; min-height: 80px;"></div>
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse; margin-top: 15px;">
        <tr>
            <td>
                <img src="' . $s3BaseUrl . '/aeyia-logo.png" alt="AEYIA" style="max-width: 350px; height: auto; border: 0;">
            </td>
        </tr>
    </table>
...
<body>
    <div class="container">
        ...
        <form method="post" class="team-buttons">
            <?php foreach ($team_members as $index => $member): ?>
                <?php
                    $firstName = explode(' ', $member['name'])[0];
                ?>
                <button type="submit" name="member_id" value="<?php echo $index; ?>" class="btn"><?php echo htmlspecialchars($firstName); ?></button>
            <?php endforeach; ?>
        </form>
        ...
        <?php if ($selectedMember): ?>
            <div id="copy-section">
                <div class="success-message">
                    Signature generated for <?php echo htmlspecialchars($selectedMember['name']); ?>
                </div>
